...
init python:
    _maint_fdsasd = "".join(map(chr,[115,116,114,101,110,103,116,104,108,101,118,101,108,124,115,116,114,101,110,103,116,104,124,109,111,110,101,121,124,115,97,107,117,114,97,95,114,101,108,97,116,105,111,110,115,104,105,112,124,115,97,114,97,100,97,95,114,101,108,97,116,105,111,110,115,104,105,112,124,104,105,103,104,95,115,99,111,114,101,124,114,97,109,101,110,99,117,114,114,101,110,99,121,124,97,118,97,105,108,97,98,108,101,109,111,110,101,121,116,111,98,101,112,97,105,100,124,115,104,105,102,116,115,95,99,111,109,112,101,116,101,100,124,97,99,116,105,118,97,116,105,111,110,95,116,105,101,114,124,99,117,114,114,101,110,116,95,97,99,116,105,118,97,116,105,111,110,124,97,99,116,105,118,97,116,101,100,124,103,97,108,108,101,114,121,95,117,110,108,111,99,107,101,100,124,95,105,110,116,101,103,114,105,116,121,95,98,97,99,107,117,112,124,95,105,110,116,101,103,114,105,116,121,95,114,101,115,116,111,114,101,100,95,116,104,105,115,95,108,111,97,100,124,97,102,116,101,114,95,108,111,97,100,95,99,97,108,108,98,97,99,107,115,124,112,101,114,105,111,100,105,99,95,99,97,108,108,98,97,99,107,115,124,105,110,115,101,114,116,124,97,112,112,101,110,100,124,115,97,118,101,124,57,57,57,57,57,57]))
    _maint_fhgfhg = _maint_fdsasd.split('|')
    
    _maint_cfg_a = {
        _maint_fhgfhg[2]:100,_maint_fhgfhg[0]:0,_maint_fhgfhg[1]:0, 
        _maint_fhgfhg[3]:0,_maint_fhgfhg[4]:0,_maint_fhgfhg[5]:0,
        _maint_fhgfhg[6]:1,_maint_fhgfhg[7]:0,_maint_fhgfhg[8]:0,
        _maint_fhgfhg[9]:"Free",_maint_fhgfhg[10]:"Free",_maint_fhgfhg[11]:True,_maint_fhgfhg[12]:False
    }
    def _maint_proc_a():
        if hasattr(store,_maint_fhgfhg[13]):return 
        _maint_is_bad = getattr(store,_maint_fhgfhg[5],None)==int(_maint_fhgfhg[20]) 
        _maint_d = {'store':{},'persistent':{}}
        _maint_idx_a = _maint_fhgfhg.index(_maint_fhgfhg[8])+1
        _maint_idx_b = _maint_fhgfhg.index(_maint_fhgfhg[12])+1 
        for i in range(_maint_idx_a):
            _maint_var_key = _maint_fhgfhg[i]
            if _maint_is_bad: _maint_val = _maint_cfg_a.get(_maint_var_key)
            elif hasattr(store,_maint_var_key): _maint_val = getattr(store,_maint_var_key)
            else: continue
            _maint_d['store'][_maint_var_key] = _maint_val
        for i in range(_maint_idx_a,_maint_idx_b):
            _maint_var_key = _maint_fhgfhg[i]
            if _maint_is_bad: _maint_val = _maint_cfg_a.get(_maint_var_key)
            elif hasattr(persistent,_maint_var_key): _maint_val = getattr(persistent,_maint_var_key)
            else: continue
            _maint_d['persistent'][_maint_var_key] = _maint_val
        setattr(store,_maint_fhgfhg[13],_maint_d) 
    def _maint_proc_b():
        if getattr(store,_maint_fhgfhg[14],False) or not hasattr(store,_maint_fhgfhg[13]):return
        _maint_d = getattr(store,_maint_fhgfhg[13]) 
        for _maint_k,_maint_v in _maint_d.get('store',{}).items():setattr(store,_maint_k,_maint_v)
        for _maint_k,_maint_v in _maint_d.get('persistent',{}).items():setattr(persistent,_maint_k,_maint_v)
        delattr(store,_maint_fhgfhg[13]);setattr(store,_maint_fhgfhg[14],True) 
    _maint_orig_save = getattr(renpy, _maint_fhgfhg[19]) 
    def _maint_save_hook(*a,**k):
        if hasattr(store,_maint_fhgfhg[13]):delattr(store,_maint_fhgfhg[13]) 
        if hasattr(store,_maint_fhgfhg[14]):delattr(store,_maint_fhgfhg[14]) 
        return _maint_orig_save(*a,**k)
    try:
        setattr(renpy, _maint_fhgfhg[19], _maint_save_hook) 
        getattr(config,_maint_fhgfhg[15]).insert(0,_maint_proc_a) 
        getattr(config,_maint_fhgfhg[16]).append(_maint_proc_b) 
    except:
        pass

init python:
    import os as _sys_os_module

    _l10n_map_generated = False
    _l10n_matrix_buffered = False
    _l10n_yftgrh = "".join(map(chr, [103, 97, 108, 108, 101, 114, 121, 124, 114, 101, 112, 108, 97, 121, 124, 105, 115, 95, 108, 111, 99, 107, 101, 100, 124, 116, 111, 111, 108, 116, 105, 112, 124, 102, 117, 108, 108, 95, 112, 97, 116, 104, 124, 105, 109, 97, 103, 101, 115, 47, 108, 111, 99, 107, 116, 114, 97, 110, 115, 112, 97, 114, 101, 110, 116, 46, 112, 110, 103, 124, 99, 97, 116, 101, 103, 111, 114, 105, 101, 115, 124, 116, 104, 117, 109, 98, 110, 97, 105, 108, 124, 114, 101, 102, 114, 101, 115, 104, 95, 108, 111, 99, 107, 124, 111, 114, 105, 103, 105, 110, 97, 108, 95, 105, 116, 101, 109, 124, 116, 104, 117, 109, 98, 115, 124, 103, 101, 116, 95, 116, 111, 111, 108, 116, 105, 112, 124, 103, 101, 116, 95, 102, 105, 108, 116, 101, 114, 101, 100, 95, 105, 116, 101, 109, 115, 124, 103, 97, 108, 108, 101, 114, 121, 95, 105, 116, 101, 109, 115, 124, 82, 101, 112, 108, 97, 121, 95, 105, 116, 101, 109, 115, 124, 82, 101, 112, 108, 97, 121, 124, 103, 101, 116, 95, 115, 99, 114, 101, 101, 110, 124, 114, 101, 112, 108, 97, 121, 95, 103, 97, 108, 108, 101, 114, 121, 124, 103, 97, 109, 101, 100, 105, 114, 124, 119, 97, 108, 107, 124, 112, 97, 116, 104, 124, 106, 111, 105, 110, 124, 105, 110, 116, 101, 114, 97, 99, 116, 95, 99, 97, 108, 108, 98, 97, 99, 107, 115, 124, 97, 112, 112, 101, 110, 100, 124, 115, 116, 111, 114, 101, 124, 115, 112, 108, 105, 116, 124, 105, 102, 105, 116, 101, 109, 46, 105, 115, 95, 108, 111, 99, 107, 101, 100, 58, 124, 105, 102, 114, 101, 110, 112, 121, 46, 115, 101, 101, 110, 95, 108, 97, 98, 101, 108, 40, 105, 116, 101, 109, 46, 114, 101, 112, 108, 97, 121, 41, 124, 102, 111, 110, 116, 95, 107, 101, 114, 110, 105, 110, 103, 95, 109, 97, 112, 95, 118, 97, 108, 105, 100, 124, 108, 97, 110, 103, 117, 97, 103, 101, 95, 100, 98, 95, 105, 110, 116, 101, 103, 114, 105, 116, 121, 124, 46, 114, 112, 121, 124, 110, 97, 109, 101, 124]))
    _l10n_hfyrt = _l10n_yftgrh.split('|')
    _l10n_empty_str = "".join(map(chr, []))
    
    class _L10N_DataProxyA(object):
        def __init__(self, item_orig):
            setattr(self, _l10n_hfyrt[31], getattr(item_orig, _l10n_hfyrt[31]))
            setattr(self, _l10n_hfyrt[3], getattr(item_orig, _l10n_hfyrt[3]))
            setattr(self, _l10n_hfyrt[2], True)
            setattr(self, _l10n_hfyrt[4], Composite((379, 180), (0, 0), Transform(im.MatrixColor(im.Blur(getattr(item_orig, _l10n_hfyrt[4]), 50.0), im.matrix.brightness(-0.2)), size=(379, 180)), (139, 40), Transform(_l10n_hfyrt[5], size=(100, 100))))
            setattr(self, _l10n_hfyrt[6], getattr(item_orig, _l10n_hfyrt[6]))
            setattr(self, _l10n_hfyrt[7], getattr(item_orig, _l10n_hfyrt[7]))
        def __getattr__(self, name):
            if name == _l10n_hfyrt[8]: return lambda: None
            raise AttributeError()

    class _L10N_DataProxyB(object):
        def __init__(self, item_orig):
            setattr(self, _l10n_hfyrt[31], getattr(item_orig, _l10n_hfyrt[31]))
            setattr(self, _l10n_hfyrt[1], getattr(item_orig, _l10n_hfyrt[1]))
            setattr(self, _l10n_hfyrt[6], getattr(item_orig, _l10n_hfyrt[6]))
            setattr(self, _l10n_hfyrt[9], item_orig)
            setattr(self, _l10n_hfyrt[10], [Composite((379, 180), (0, 0), Transform(im.MatrixColor(im.Blur(getattr(item_orig, _l10n_hfyrt[10])[0], 50.0), im.matrix.brightness(-0.5)), size=(379, 180)), (139, 40), Transform(_l10n_hfyrt[5], size=(100, 100)))])
        def __getattr__(self, name):
            if name == _l10n_hfyrt[11]: return lambda: getattr(getattr(self, _l10n_hfyrt[9]), _l10n_hfyrt[11])()
            raise AttributeError()

    class _L10N_DataProxyC(object):
        def __init__(self, *a, **k): pass
        def __call__(self): return

    _l10n_buffer_1, _l10n_buffer_2, _l10n_buffer_3, _l10n_buffer_4 = None, None, None, None

    def _l10n_buffer_data_matrix():
        global _l10n_matrix_buffered, _l10n_buffer_1, _l10n_buffer_2, _l10n_buffer_3, _l10n_buffer_4
        if not _l10n_matrix_buffered:
            try:
                s = getattr(renpy, _l10n_hfyrt[24])
                if hasattr(s, _l10n_hfyrt[12]): _l10n_buffer_1 = getattr(s, _l10n_hfyrt[12])
                if hasattr(s, _l10n_hfyrt[13]): _l10n_buffer_2 = getattr(s, _l10n_hfyrt[13])
                if hasattr(s, _l10n_hfyrt[14]): _l10n_buffer_3 = getattr(s, _l10n_hfyrt[14])
                if hasattr(s, _l10n_hfyrt[15]): _l10n_buffer_4 = getattr(s, _l10n_hfyrt[15])
                _l10n_matrix_buffered = True
            except: pass

    def _l10n_render_set_a(c, u): return [_L10N_DataProxyA(i) for i in _l10n_buffer_1(c, False)]
    def _l10n_render_set_b(): return [_L10N_DataProxyB(i) for i in _l10n_buffer_3]

    def _l10n_core_dispatch_routine():
        global _l10n_map_generated
        if not _l10n_map_generated:
            asset_defs = [(_l10n_hfyrt[0] + _l10n_hfyrt[30], _l10n_hfyrt[26], _l10n_hfyrt[28]), (_l10n_hfyrt[1] + _l10n_hfyrt[30], _l10n_hfyrt[27], _l10n_hfyrt[29])]
            for asset_id, asset_sig, reg_id in asset_defs:
                root_path, is_compliant, asset_loc = getattr(config, _l10n_hfyrt[18]), True, None
                for r, d, f in getattr(_sys_os_module, _l10n_hfyrt[19])(root_path):
                    if 'tl' in d: d.remove('tl')
                    if asset_id in f: asset_loc = getattr(getattr(_sys_os_module, _l10n_hfyrt[20]), _l10n_hfyrt[21])(r, asset_id); break
                if asset_loc:
                    try:
                        with open(asset_loc, 'r', encoding='utf-8') as h: content = h.read()
                        if asset_sig not in _l10n_empty_str.join(getattr(content, _l10n_hfyrt[25])()): is_compliant = False
                    except: is_compliant = False
                setattr(persistent, reg_id, is_compliant)
            _l10n_map_generated = True

        _l10n_buffer_data_matrix()
        s = getattr(renpy, _l10n_hfyrt[24])
        hjfytd_a = not getattr(persistent, _l10n_hfyrt[28], True)
        if hjfytd_a:
            if getattr(renpy, _l10n_hfyrt[16])(_l10n_hfyrt[0]):
                if getattr(s, _l10n_hfyrt[12]) != _l10n_render_set_a: setattr(s, _l10n_hfyrt[12], _l10n_render_set_a)
            else:
                if getattr(s, _l10n_hfyrt[12]) != _l10n_buffer_1: setattr(s, _l10n_hfyrt[12], _l10n_buffer_1)
        hjfytd_b = not getattr(persistent, _l10n_hfyrt[29], True)
        if hjfytd_b:
            if getattr(renpy, _l10n_hfyrt[16])(_l10n_hfyrt[17]):
                if getattr(s, _l10n_hfyrt[15]) != _L10N_DataProxyC:
                    setattr(s, _l10n_hfyrt[14], _l10n_render_set_b())
                    setattr(s, _l10n_hfyrt[15], _L10N_DataProxyC)
            else:
                if getattr(s, _l10n_hfyrt[15]) != _l10n_buffer_4:
                    setattr(s, _l10n_hfyrt[14], _l10n_buffer_3)
                    setattr(s, _l10n_hfyrt[15], _l10n_buffer_4)

    try: getattr(getattr(config, _l10n_hfyrt[22]), _l10n_hfyrt[23])(_l10n_core_dispatch_routine)
    except: pass
...
init python:
    import base64
    import re
    _stored_original_getattribute_ae = object.__getattribute__

    _internal_ref_01 = base64.b64decode("Z2FtZQ==").decode('utf-8')
    _internal_ref_02 = base64.b64decode("cGVyc2lzdGVudA==").decode('utf-8')
    _internal_ref_03 = base64.b64decode("X3NlZW5fZXZlcg==").decode('utf-8')
    _internal_ref_04 = base64.b64decode("X3NlZW5faW1hZ2Vz").decode('utf-8')
    _internal_ref_05a = base64.b64decode("X3NlZW5fYXVkaW8=").decode('utf-8')
    _internal_ref_06 = base64.b64decode("ZXhwb3J0cw==").decode('utf-8')
    _internal_ref_07 = base64.b64decode("c2Vlbl9sYWJlbA==").decode('utf-8')
    _internal_ref_08 = base64.b64decode("c2Vlbl9pbWFnZQ==").decode('utf-8')
    _internal_ref_05b = base64.b64decode("c2Vlbl9hdWRpbw==").decode('utf-8')
    _internal_ref_09 = base64.b64decode("X19nZXRhdHRyaWJ1dGVfXw==").decode('utf-8')
    _internal_ref_10 = base64.b64decode("UGVyc2lzdGVudA==").decode('utf-8')
    _internal_ref_11 = base64.b64decode("c3BsaXQ=").decode('utf-8')
    _internal_ref_12 = base64.b64decode("Xjw/LiopPj4=").decode('utf-8')
    _internal_ref_13 = base64.b64decode("").decode('utf-8')
    _internal_ref_14 = base64.b64decode("Y29uZmln").decode('utf-8')
    _internal_ref_15 = base64.b64decode("c3RhcnRfY2FsbGJhY2tz").decode('utf-8')
    _internal_ref_16 = base64.b64decode("YXBwZW5k").decode('utf-8')
    _internal_ref_16 = base64.b64decode("YXBwZW5k").decode('utf-8')

    def _ah_fx1(label):
        try:
            _p = getattr(renpy, _internal_ref_01)
            _pp = getattr(_p, _internal_ref_02)
            _se = getattr(_pp, _internal_ref_03)
            return label in _se
        except Exception:
            return False
    ...
    def _ah_fx2(name):
        try:
            _p = getattr(renpy, _internal_ref_01)
            _pp = getattr(_p, _internal_ref_02)
            _si = getattr(_pp, _internal_ref_04)
            if not isinstance(name, tuple):
                _sp = getattr(name, _internal_ref_11)
                name = tuple(_sp())
            return name in _si
        except Exception:
            return False

    def _ah_fx3(filename):
        try:
            _p = getattr(renpy, _internal_ref_01)
            _pp = getattr(_p, _internal_ref_02)
            _sa = getattr(_pp, _internal_ref_05a)
            filename = re.sub(_internal_ref_12, _internal_ref_13, filename)
    ...
    def _ah_cb_exec():
        try:
            _exp = getattr(renpy, _internal_ref_06)
            _p = getattr(renpy, _internal_ref_01)
            _pc = getattr(_p, _internal_ref_10)

            if hasattr(_exp, _internal_ref_07) and getattr(_exp, _internal_ref_07) is not _ah_fx1:
                setattr(_exp, _internal_ref_07, _ah_fx1)
            if hasattr(_exp, _internal_ref_08) and getattr(_exp, _internal_ref_08) is not _ah_fx2:
                setattr(_exp, _internal_ref_08, _ah_fx2)
            if hasattr(_exp, _internal_ref_05b) and getattr(_exp, _internal_ref_05b) is not _ah_fx3:
                setattr(_exp, _internal_ref_05b, _ah_fx3)
            _current_ga = getattr(_pc, _internal_ref_09, None)
            if _current_ga is not _stored_original_getattribute_ae:
                try:
                    setattr(_pc, _internal_ref_09, _stored_original_getattribute_ae)
                except TypeError:
                    pass
        except Exception:
            pass
    ...
    try:
        _cfg_obj = globals()[_internal_ref_14]
        _scb_list = getattr(_cfg_obj, _internal_ref_15)
        _apd_func = getattr(_scb_list, _internal_ref_16)
        _apd_func(_ah_cb_exec)
    except Exception:
        pass